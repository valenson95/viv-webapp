                ...
                return (
                  <React.Fragment key={p.id}>
                    <tr className={"posrow" + (isOpen ? " mg-open" : "")}>
                      ...
                      <td data-l="Realized">{p.realizedShares > 0 ? (
                        <span className="sizebar" title={`${p.realizedShares} of ${p.origShares} shares sold (${p.trimPct.toFixed(0)}% trimmed)`}>
                          ...
                          <small><span style={{ color: p.realizedPL >= 0 ? "var(--green)" : "var(--red)", fontWeight: 700 }}>{usdSigned(p.realizedPL)}</span> · {p.trimPct.toFixed(0)}% trimmed</small>
                        </span>
