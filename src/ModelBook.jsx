...
const PLAYBOOK_PIECES = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { p: `There is no fixed number. I set a minimum gain, then raise or lower it until the list is short enough to chart tonight. I use the same three periods as the ranking: one month, three months, six months.` },
