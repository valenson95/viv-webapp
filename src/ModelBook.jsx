...
const PLAYBOOK_PIECES = [
  {
    ...
    blocks: [
      ...
      { h: `Why it matters` },
      { p: `One question decides how the whole day is played: is this a market where breakouts work, or one where they get sold? This check never picks your stocks for you. It sets how big you trade and how patient you are. The same setup, in the same stock, can be a full-size trade one week and a pass the next.` },
      { h: `How we measure it` },
      ...
      { ul: [
        ...
        `[b]A surge in up-moves[/b] — a sudden burst of big gainers after a weak stretch. This is a known turn signal, and it is why we check every day rather than once a week.`,
      ...
      { h: `In practice` },
      { p: `Strong market: the full playbook. Mixed: half size, take profit sooner, and only the best setups. Weak: the best work you can do is build the watchlist for when it turns. Check once, before you open the watchlist, and let that answer stand for the day. Everything else in this book assumes you have done it.` },
      { fig: { w: 560, img: `https://ifahfxsqgmzyxcebslwe.supabase.co/storage/v1/object/public/trade-charts/modelbook/playbook/lens-breadth.png`, cap: `The reading as members see it. Two panels, two time frames: the month pair reads 81 up versus 266 down — sellers lead — while the quarter pair is near balanced at 1,213 against 1,196. When the two time frames disagree like this, the market is choppy — and the card says so in one line: [b]breakouts are less likely to work[/b]. It is a reading, not an opinion.` } },
      { h: `Common mistakes` },
      { p: `Trading the market you wish you had instead of the one in front of you. The most tempting mistake is buying the first green day after heavy selling: it feels like the turn, and most of the time it fades by lunch. Wait for the market to confirm. And check before you enter, not after — checking afterwards is the same mistake, just later.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: `How we measure it` },
      { p: `We track how every group has performed over the past week and the past month, and mark the top five on each list. A stock whose group is on those lists is in-theme. The rule is written down on purpose, so a good-looking chart cannot talk you out of it.` },
      { h: `In practice` },
      { fig: { w: 700, img: `https://ifahfxsqgmzyxcebslwe.supabase.co/storage/v1/object/public/trade-charts/modelbook/playbook/lens-themes-full.png`, cap: `The list members read each morning: thirty-one groups, ranked three ways at once. [b]Since Open[/b] measures the move from the opening price rather than from yesterday's close — so it shows what buyers actually did during the day, instead of what the gap handed them. Compare the columns against each other: Bitcoin Miners lead the day but sit near the bottom of the month, which is a bounce, not leadership; China Internet and Steel are top-five on both the week and the month, which is. Click to zoom.` } },
      { p: `In-theme stocks get the full playbook. If the group is not on either list, the bar goes up: the setup has to be excellent, the size smaller, and you give it less room. Check the group before the chart, and read the two lists together:` },
      { ul: [
      ...
      { h: `Common mistakes` },
      { p: `Staying in love with one stock while its whole group turns down. Ignoring the rule because the story is exciting — if the story were real, the group would already show it. And deciding a stock's group by instinct: which group a stock trades with is something you look up, never something you decide for yourself.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `Rotation is money moving from one group to another. Between the whole market and the single stock sits the group table: every group ranked against its own recent history, with a second, faster reading for this week. Strong on both means the group is leading and speeding up — those are the groups to hunt in.` },
      { h: `Why it matters` },
      { p: `Rotation turns "the market is fine" into "look here". It also carries one distinction worth real money: a group can reach the top of the table in two very different ways, and only one of them is leadership. A group bouncing off its lows still has sellers waiting overhead who bought higher. A group at new highs has none.` },
      { h: `How we measure it` },
      { ul: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: `Why it matters` },
      { p: `Big buyers leave tracks long before the news explains why. This is where those tracks show up: [b]a stock that refuses to make new lows while the index is making them is being bought by someone.[/b] The ranking is published every day, it is free, and it moves before the story does.` },
      { h: `How we measure it` },
      { ul: [
      ...
      { h: `In practice` },
      { p: `The ranking is the first filter: a stock that fails it never gets charted. When two stocks both pass, the tie-breaker is how they behaved on the market's worst days. A stock that made a higher low while the index made a lower one is showing you the next leader — and that is worth more than a few points of rank.` },
      { h: `Common mistakes` },
    ...
    take: `The market ranks every stock every day. Read the ranking; don't argue with it.`,
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `The funnel is the nightly routine that turns thousands of listed names into the fewer than fifty that matter on any given day: three scans feeding one watchlist, and from that watchlist a short focus list. It is deliberately mechanical — the same three scans, run the same way, every evening.` },
      { h: `Why it matters` },
      ...
      { h: `How we measure it` },
      { ul: [
        `[b]The movers ladder[/b] — top gainers over one, three, and six months, with minimum volume floors (both dollar volume [i]and[/i] share volume — each one catches what the other misses) and a minimum daily range. The overlap pattern is the read: on all three lists = persistent leader; on the longer lists but off the short one = a winner resting. The resters are tomorrow's entries.`,
        `[b]The CANSLIM scanner[/b] — the growth scan: current-quarter earnings and sales both growing hard, a multi-year record behind them, high relative strength, and price already near its 52-week high. It answers a different question from the top-gainers list — not "what moved" but "what has real growth underneath it."`,
        `[b]The pre-market gappers[/b] — the last activity before the open, run around 9:25 New York time when the real list has formed. This is the scan built for episodic pivots. Gap size, live volume, and the one thing a screener can't see — was anyone positioned for this?`,
      ] },
      { h: `In practice` },
      { p: `Scan in the evening, when the market is closed and nothing is moving. The scan builds the watchlist; only the chart builds the trade. Keep the focus list to six to twelve names — if everything is interesting, nothing is. Stocks that pass a scan but not the chart stay on the watchlist; names that clear both move to the focus list and get a written trigger and stop.` },
      ...
      { kv: [
        ...
        [`Avg vol, 10D > 500K`, `The share-volume floor: enough shares changing hands that you can get in and out at size without moving the price.`],
        [`Price × avg vol, 10D > 5M USD`, `The dollar-volume floor. The two volume filters cover each other's blind spots — share volume alone lets in three-dollar lottery tickets, and dollar volume alone lets in thinly traded, high-priced stocks.`],
      ...
      { fig: { img: `https://ifahfxsqgmzyxcebslwe.supabase.co/storage/v1/object/public/trade-charts/modelbook/playbook/screener-3m.png`, cap: `The same screen sorted by three months instead. Stocks near the top of both this and the one-month sort are trending on every time frame.` } },
      ...
      { p: `Eight hundred and eighty-seven stocks is a starting pool, not a watchlist. Every filter is a lever — raise the bar until each sort holds under about fifty stocks, and let the overlap between the three sorts become the real list:` },
      { ul: [
      ...
      { h: `The second scan — CANSLIM, filter by filter` },
      { p: `The top-gainers scan finds what has already moved. This one finds [i]why[/i] it should keep moving: eight conditions, all required together, that demand real revenue growth, a name already in an uptrend, and a float small enough for that growth to matter. Same platform as the first scan — a stock passes every line or it isn't on the list:` },
      { kv: [
        [`Price > 3 USD`, `The price floor — the same junk-tier cut the ladder makes.`],
        [`Mkt cap > 300M USD`, `Minimum institutional size. Funds cannot build a position below this, so their buying never shows up in the price.`],
        [`Revenue growth, quarterly YoY > 25%`, `The fundamental engine. Revenue, not earnings — profits can be manufactured by cost-cutting for a few quarters; sales cannot. Twenty-five percent year over year is where a quarter is genuinely different from the year before it.`],
        [`Avg vol, 60D > 500K`, `The liquidity floor, measured over a longer window than the ladder's so a single news spike can't sneak a thin name through.`],
        [`SMA 50 < Price`, `Price above its 50-day line — the name must already be in an uptrend. This one filter is what keeps the screen from filling with cheap growth stories still in downtrends.`],
        [`Volatility > 3%`, `The movement floor. A stock that doesn't travel cannot pay for its stop, however good the fundamentals read.`],
        [`Float < 150M`, `Share scarcity. The same demand against a smaller float produces a far bigger move — this is the filter that turns good growth into violent price action.`],
        [`Price above 52-week low by 70% or more`, `Proof the market already re-rated it. We want names well off their lows and working toward highs — leaders break out from strength, not from repair.`],
      ] },
      { fig: { w: 700, img: `https://ifahfxsqgmzyxcebslwe.supabase.co/storage/v1/object/public/trade-charts/modelbook/playbook/screener-canslim.png`, cap: `The CANSLIM screen as it is actually saved. Eight chips leave 56 names — a list small enough to chart in one sitting, which is exactly the point of a growth scan. The Overview tab is the right one here: relative volume, market cap and earnings growth read at a glance beside the price.` } },
      { h: `Tightening the CANSLIM scan` },
      { p: `Same rule of thumb as before: if a scan returns more stocks than you can chart in an evening, it is too loose. Raise the bars until it holds under about fifty:` },
      { ul: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: `Why it matters` },
      { p: `The chart triggers every trade in this book — the staircase does a different job. It tells you whether a stock is worth holding for weeks and adding to, or is just a quick trade you keep on a short rein. Growth decides how long you hold and how much you add. It never decides when you buy.` },
      { h: `How we measure it` },
      ...
      { h: `In practice` },
      { p: `The chart still decides when you buy. The growth decides how much you are willing to sit through: how long you hold when it gets noisy, and whether you add to it. Great chart with no growth behind it — take the quick trade and keep it on a short rein. Great chart, growing every quarter, in a group being bought — that is the one you work.` },
      { h: `Common mistakes` },
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `The no-buy list is a fixed set of deal-breakers, written down before you need them. It is not a score to be weighed up — a single "yes" ends the conversation, no matter how good the chart looks or how loud the story is.` },
      { h: `Why it matters` },
      ...
      { ul: [
        ...
        `Your total open risk is already at its cap — there is no room for another stop.`,
        `The honest reason is boredom, a losing day, or wanting to feel like you are doing something. The market owes you nothing.`,
      ] },
      { h: `In practice` },
      { p: `The list hangs above the desk and is run before the order exists, not after the fill. Eight questions take seconds. Answer them out loud, in order. One yes means no — seven clean answers do not outvote one bad one.` },
      { h: `Common mistakes` },
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: `Why it matters` },
      { p: `Each pullback removes another group of sellers. The first shakes out the nervous holders, the second shakes out the people who bought the first dip, and by the last one there is barely anyone left who wants to sell. That is why you can read this pattern before it breaks: the pullbacks getting smaller is sellers running out, happening in plain sight. The tightening is the edge. The breakout is just the confirmation.` },
      { h: `How we measure it` },
      { p: `Three stages, each with its own signs. [b]One — the move before the base:[/b] a real advance of thirty percent or more into the base, and a clean linear one, not a whipsawing zig-zag. We want a young trend: the first, second or third base of the run, not a late one. [b]Two — the contraction sequence:[/b]` },
      { ul: [
        `Each pullback visibly shallower than the last, with the depth roughly [i]halving[/i] left to right — twenty-five percent, then twelve, then six.`,
        `The final contraction tight — ten percent deep or less, a drift rather than a swing.`,
        `Volume drying up through the base, with the driest volume of the whole base printing inside that final contraction.`,
        `Higher lows into the pivot, price surfing its rising 10-, 20- and 50-day lines.`,
        `Extra signs worth noting: inside bars right before the trigger, and the 10-, 20- and 50-day lines coming together at the pivot.`,
      ] },
      ...
      { h: `In practice` },
      { p: `The nightly scans find the candidates, the three stages qualify them, and the entry checklist times the buy: the opening-range trigger on the breakout day, stop at that day's low. Until the expansion arrives, a contraction pattern is a watchlist name and nothing more. Size is worked out the same way as always — from the stop, exactly as in piece fourteen. What the age of the base changes is whether the trade qualifies at all — a fourth base is on the no-buy list.` },
      { h: `Common mistakes` },
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: `Why it matters` },
      { p: `A stock that doubles in weeks and then [i]refuses to give it back[/i] is telling you something no other pattern says as loudly: not one holder is willing to sell into a hundred-percent gain. That says something about demand that no other pattern says as clearly. The whole edge is in that refusal to sell, which is why the tightness of the pause is not a detail — it is the setup.` },
      { h: `How we measure it` },
      { ul: [
        `[b]The pole[/b] — roughly a double, ninety to a hundred percent or more, in eight weeks or less. Orderly, around forty-five degrees, strong closes and minimal overlap. A single vertical spike day is not a pole. A fresh catalyst or clear theme leadership driving it is a bonus.`,
        `[b]The flag, shallow[/b] — no more than twenty to twenty-five percent off the pole high. Deeper than that and it is a correction, not a flag.`,
        `[b]The flag, brief[/b] — three to five weeks, and not stretching much past eight. Time is the enemy here; the longer it drifts, the more the pole's message decays.`,
        `[b]The flag, tight[/b] — a clean drift, no jagged bars, no trendline violations, with volume receding through it and narrow-range days into the pivot. It must not round out and it must not retrace deeply. The moment it does either, the setup is gone — there is no partial credit.`,
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `This is the second way into a leader you already missed. The stock pulls back to its rising short moving averages, dips [i]below[/i] a previous low or an obvious support level, and then closes back above it. The entry is not the pullback and it is not the dip below. The entry is the moment price takes that level [b]back[/b].` },
      { h: `Why it matters` },
      { p: `The dip below does something no buyer can do on his own: it triggers the stop orders sitting under the obvious level and clears out the nervous holders, so when price recovers there is far less selling left in the way. It also gives you a tight stop, because the low that was just made is the exact level the trade is arguing about — a few percent of risk on a leader mid-trend.` },
      { h: `How we measure it` },
      { ul: [
        `[b]Moving averages still rising[/b] — the short ones sloping up, with price still above the longer ones. A pullback into flat or falling averages is a different, worse trade.`,
      ...
      { h: `Common mistakes` },
      { p: `Buying while price is still falling, before it recovers the level — which turns a tight stop into a very wide one. Mistaking a weak bounce in an already-broken stock for a pullback: a pullback keeps the uptrend intact, a breakdown has already lost it. And taking the fourth or fifth pullback of an aging trend as though it were the first.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `An episodic pivot — a buyable gap up — is the market suddenly having to reprice a stock almost nobody owned. Genuinely new information lands on a forgotten stock, it opens ten percent or more above yesterday's close, and volume floods in so fast the stock trades a normal day's volume inside the first thirty minutes. This is the setup the pre-market gapper scan is built for, and it is why that scan runs before every open.` },
      { h: `Why it matters` },
      { p: `These are the rarest setups in the book — only a handful a year. The gap itself is not the move. It is the announcement that the repricing has started, and that process usually takes weeks to play out. Everything that makes these work can be checked on the day.` },
      { h: `How we measure it` },
      { ul: [
        ...
        `[b]The first surprise[/b] — no recent prior gap of this kind on the chart. The first one reprices; the third one is priced in.`,
        `[b]The gap itself[/b] — ten percent or more visible, or a four-percent-plus range expansion on an earnings day.`,
        `[b]Volume that proves it[/b] — a huge bar that dwarfs the recent ones, at least three times the normal daily volume by the close, with pre-market flow leading the way and the first thirty minutes already on pace for a full average day.`,
        `[b]It holds the gap[/b] — closes in the upper part of the day's range, above the prior day. Closing back inside the gap is the rejection.`,
        `[b]A stop that fits[/b] — a tight structure available within about one to one-and-a-half daily ranges, and clear air overhead: no overhead resistance nearby to chew through.`,
      ] },
      { h: `In practice` },
      { p: `Two ways in. [b]Day one:[/b] the five-minute opening-range high, stop at the day's low. [b]The delayed entry:[/b] when the gap is too large to size sanely against the day's low, wait for the first constructive day — the first tight pause or higher low above the gap — and use that structure instead. Missing the first hour costs little; the real move takes weeks.` },
      { h: `Common mistakes` },
      { p: `Buying the open before any range exists, then discovering the stop is a third of the position. Calling a rehashed headline new information. Taking a gap on a name that already ran, where the news is confirmation rather than surprise. And holding one that closed back down inside the gap, hoping tomorrow fixes it — if it hesitates, it lied.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `This is the one setup we take from the short side, and it comes in two versions. [b]The parabolic[/b]: a stock that has gone vertical, far above every rising moving average, and finally cracks. [b]The breakdown[/b]: a former leader that has already topped, distributed, rolled over, and then loses a level it had been leaning on. Both are the same trade in different clothing: we are selling something that has [i]already[/i] broken down.` },
      { h: `Why it matters` },
      { p: `Say it plainly: this is not shorting strength. Shorting a leader because it "looks too high" is how accounts end. The whole idea here is that the top has already happened — the heavy selling has shown up, the moving averages have turned down, the support level has broken — and we are trading what comes after. Everything in the criteria below exists to prove the top happened before we take the trade.` },
      { h: `How we measure it` },
      { p: `[b]The parabolic version[/b] — the exhaustion trade:` },
      { ul: [
        `Vertical stretch: fifty to a hundred percent on a large name, three hundred percent or more on a small one, in days to weeks.`,
        `Three to five or more consecutive up days into the climax.`,
        `Visibly far above all of its rising moving averages — climactic on sight, not on opinion.`,
        `[b]Trigger:[/b] the first crack — a big red bar, or a break of the opening range in our direction. Intraday, a failure at the volume-weighted average price confirms it.`,
        `[b]Structure:[/b] stop at the day's extreme, one daily range or less, and enough room down to the 10- or 20-day line for the target to pay.`,
      ] },
      { p: `[b]The breakdown version[/b] — the failed leader:` },
      { ul: [
        `Distribution at the top: failed highs and big red high-volume days.`,
        `The averages roll over — price below the 10-, 20- and 50-day lines with those lines turning down.`,
        `Lower highs forming into the support level, and the 50-day lost with no reclaim within a few sessions.`,
        `Relative-strength decay: the stock goes down on days the index goes up. That tell usually comes before the break.`,
        `The level wears out — three or more tests of the same support, with weak low-volume bounces in between that cannot get back to the falling 20-day line. A tightening bear-flag coil sitting on the level is the ideal shape.`,
      ...
      { h: `In practice` },
      { p: `The short side is smaller by default: half the per-trade risk of a long, and total short exposure kept under half of what we would carry long in a healthy market. Targets are the 10- and 20-day lines, not a collapse. These trades work in exactly the markets where our long positions should already be shrinking, which is why the setup exists at all.` },
      { h: `Common mistakes` },
      { p: `Shorting a strong stock because it is up a lot — up a lot is not a signal, and a leader can stay parabolic far longer than the position can survive. Selling the intraday undercut before a close below the level, then getting reclaimed. Taking the first bounce off support as the breakdown. And shorting at the same size you would go long: the risk is not the same, because a short can keep going against you without limit.` },
    ],
    take: `We do not short strength — we trade a structure that already failed. No top, no trade.`,
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `An entry is not a price — it is the moment buyers show they are in control. Three things have to agree before that moment counts: a trigger, a confirmation, and a stop. The three are the same on every setup in this book.` },
      { h: `Why it matters` },
      { p: `The entry is the one moment where the risk is completely in your hands, and these three checks are what stop a good setup from becoming a bad position. A trigger on its own proves very little: price pokes through levels all day long. What separates a breakout from a poke is participation, which is why the volume check is not optional here — without it, the prettiest trigger is a trap.` },
      { h: `How we measure it` },
      { ul: [
      ...
      { h: `In practice` },
      { p: `The three are checked in order, out loud, before the click — one sentence each. All three or none: a trigger without volume is a pass, and a trigger with volume but a stop wider than one daily range is either a smaller position or no position. You know the stop before you know the share count, because the next piece turns that distance into the number of shares.` },
      { h: `Common mistakes` },
      { p: `Buying mid-bar with no trigger. Entering at lunch on the morning's news. Deciding the size before you know the stop — that is backwards, as the next piece shows.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `Position sizing is one question: how much do I lose if I'm wrong? The answer is a fixed fraction of the account, decided before the trade exists. Fix that number first and the share count works itself out. Size comes out of the risk, not out of how much you like the trade.` },
      { h: `Why it matters` },
      { p: `Two traders can hold the same dollar amount of stock and be taking completely different risk. Only the distance to the stop tells you which is which. Sizing from risk makes every loss cost roughly the same, which is what turns a losing streak into an inconvenience instead of an event.` },
      { h: `How we measure it` },
      ...
      { h: `In practice` },
      { p: `The order of operations never changes: setup, then stop, then arithmetic, then order. If the maths gives you a share count that feels too small to bother with, the real answer is that the stop is too wide for your account — not that the risk percentage should go up. That percentage moves for one reason only: a drawdown.` },
      { h: `Common mistakes` },
    ...
    take: `Your results are decided by what you risk, not by what you predict. Fix the loss first, then work out the shares.`,
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `Three different ceilings protect the account, and they are not the same number. [b]Risk[/b] is what one stop-out costs you. [b]Open risk[/b] is what all your open positions cost you if they all stopped out today. [b]Exposure[/b] is how much money you have in the market at all. Three questions, three answers, three separate limits.` },
      { h: `Why it matters` },
      { p: `Each one protects against a different disaster. The first stops one trade from doing real damage. The second stops a single bad day, where everything falls at once, from doing it. The third stops the slow bleed of being too heavily invested in a weak market. You need all three — and any one of them can block a trade the other two would have allowed.` },
      { h: `How we measure it` },
      { ul: [
        `[b]Limit one — risk on a single trade.[/b] The share of the account one stop-out is allowed to cost. The sizing formula takes care of it.`,
        `[b]Limit two — total open risk.[/b] Add up every open position's distance to its stop: that is what today costs you if [i]everything[/i] stops out at once. Cap it at roughly two percent of the account. Stocks that move together count as one — three positions in the same group is really one trade in three names.`,
        `[b]Limit three — total exposure.[/b] How much of the account is invested overnight at all — roughly thirty percent of the account as the standing ceiling, and it counts [i]every[/i] overnight position including the ones whose stops are already at break-even, because a gap can open below a stop and skip it. Risk-free is not exposure-free. Inside that ceiling it moves with the market check: full when the market is strong, a fraction when it is mixed, near-zero when it is weak.`,
      ] },
      { h: `In practice` },
      { p: `Answer all three before you enter, in that order. If a new setup would push you over the open-risk cap, it waits — or you tighten a stop on something you already hold to make room. As your stops move up, open risk falls by itself and the room comes back without you doing anything.` },
      { h: `Common mistakes` },
      { p: `Treating the three as one number. This is how a trader who feels disciplined takes an undisciplined loss: a comfortable-looking amount of money invested can still be carrying three times the intended risk. Waving through a fourth position in the same group and calling it diversification. And going over a limit because the setup looks excellent — the limits exist for exactly the trades that feel worth breaking them for.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `The stop goes where the trade is proven wrong — the day's low that defined the entry, the pullback low, the level that undoes the whole idea if it breaks. Never where you simply stop feeling comfortable. It is a price on the chart, decided before you own anything, and it is the only part of a trade you fully control.` },
      { h: `Why it matters` },
      { p: `You can be average at everything else in this book and survive if you get this piece right. Get this one wrong and being excellent everywhere else will not save you. The maths of losses is lopsided: down 10% needs 11% to get back; down 25% needs 33%; down 50% needs a double. Small losses are the cost of doing business. Big ones take months to undo.` },
      { h: `How we measure it` },
      { ul: [
      ...
      { h: `In practice` },
      { p: `The stop sits in the market and you honour it without negotiating. There is a second signal worth acting on before it ever triggers: the trades that work tend to work [i]straight away[/i]. A new position that just sits there going nowhere is telling you something, and cutting it back early is a decision, not a panic.` },
      { h: `Common mistakes` },
      { p: `Widening the stop to give the trade room — that is the trade telling you it doesn't fit, and the answer is fewer shares, not more rope. Cancelling the resting order to "watch it manually." Re-entering minutes after the stop with no new trigger. And treating a stop-out as a judgement on you, rather than what it costs to find out.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `Trimming means selling part of a winner while it is still going up, so the rest can keep running without your whole position depending on one pullback. Two things tell us when: the first few days after a breakout, when a working trade usually pays fastest, and how far price has stretched above its 50-day moving average.` },
      { h: `Why it matters` },
      { p: `When a breakout works, it usually pays fast — a sharp move over the first three to five days. After that, the odds of a pullback or a stall go up. Traders who never take anything off are the ones who watch their best entries give it all back.` },
      { h: `How we measure it` },
      { ul: [
      ...
      { h: `In practice` },
      { p: `The judgement here is one question: is this a healthy trend, or a stretched one? A healthy trend grinds upward with normal rests along its moving averages — hold it. A stretched one goes near-vertical, closes right at the highs, and volume keeps building — take some off. That difference is measurable, so measure it rather than guessing.` },
      { h: `Common mistakes` },
      { p: `Selling on a feeling a day or two early, then watching the best part of the move happen without you. Taking the trim and forgetting the other half of the sequence — the stop to break-even is what makes the trim worth taking. And holding the entire position through a parabolic run because it "still looks strong," which is exactly what measuring the stretch above the 50-day is there to catch.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `The runner is the part of the position you keep after taking profit. It is managed by one trailing moving average, matched to how fast the stock moves, and read on daily closes only. That line is not a target — it is simply the level that, once lost, ends the trade.` },
      { h: `Why it matters` },
      { p: `The runner is where a good year separates from an average one. You cannot know in advance which winner keeps going for months — so every runner gets its chance to prove it — judged by a line on the chart, not by an opinion.` },
      { h: `How we measure it` },
      { ul: [
        `The lines we use: the 9- and 21-day exponential moving averages for the trail itself, read against the 10-, 20- and 50-day simple averages that show the trend on the daily chart. Fast movers follow the faster line, steadier ones the slower. Pick one line when you take profit and stick with it — swapping to a slower line later is just an excuse to keep holding.`,
        ...
        `The trade ends when the closes say so: the first clear daily close below the line, or the pattern of higher lows breaking.`,
      ] },
      { h: `In practice` },
      { p: `A quick dip below the line that closes back above it is not an exit. Allowing that is what keeps you in the trends worth holding. Check the line once, after the close, and decide the next day then. Nothing about a runner is decided in the middle of the day.` },
      { h: `Common mistakes` },
      { p: `Using the fastest line on a slow-moving stock, and getting shaken out of a good trend by normal noise. Tightening the stop because you are bored. Selling a runner because it is "up a lot" — being up a lot is the whole point.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `An add is a second or third buy into a position that is already working. A pyramid is a series of adds, each one smaller than the last. Either way you end up with one position at one average price and one risk number — never a pile of separate trades in the same stock.` },
      { h: `Why it matters` },
      { p: `Adding is how a good position becomes a great one — and how a careless one dies. The difference is entirely in when you do it. An add made when the chart gives a fresh reason increases the position without increasing the risk. An add made on a feeling increases both.` },
      { h: `How we measure it` },
      { p: `Each add is smaller than the one before it — a full first buy, then half to three-quarters of it, then a quarter to half. That keeps your average price near the original entry. Every add also forces the stop on the whole position higher, so the total risk never grows. If the stop cannot move up enough to keep the maths working, you are not allowed the add. How strongly you feel about it does not enter the calculation.` },
      { h: `In practice` },
      { p: `The rule fits in one sentence: add only when the stock proves itself again, at a fresh point on the chart, with the whole position's risk still inside the three limits. Where the adds happen:` },
      { ul: [
      ...
      { h: `Common mistakes` },
      { p: `Adding into near-vertical days far above the moving averages — that is the zone where piece seventeen says sell, not buy. You add when a stock pauses; you sell when it stretches. Getting those two backwards is the whole difference between building a position and blowing one up. And adding without moving the stop, which quietly turns one disciplined position into three undisciplined ones.` },
    ],
    take: `The stock earns the add; you don't decide it on a feeling. The chart triggers it and the risk maths approves it.`,
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `This is our written-in-advance response to a run of losses: a schedule that cuts trade size in steps as the drawdown gets deeper. Because it is decided beforehand, there is nothing to argue about in the moment. Losing streaks are a normal feature of the strategy, not a judgement on you.` },
      { h: `Why it matters` },
      { p: `Four, six, even ten losses in a row will happen inside a winning system. What separates the traders who last from the ones who don't is how big they were trading when the streak arrived, and how quickly they cut back while it lasted.` },
      { h: `How we measure it` },
      { ul: [
        `[b]Several stop-outs in a row, or the feeling that you are giving profits back:[/b] stop trading and write up what happened before placing another order. That feeling is the alarm — trades taken just to feel like you are doing something are what keep a streak going.`,
        ...
        `[b]The review:[/b] pull up your last twenty trades. Were the setups genuinely good, or stretched? Did you respect the limits, or argue with them? Had the market check already told you no? The answers are always obvious in hindsight — the protocol's job is to force the hindsight [i]now[/i].`,
      ] },
      { h: `In practice` },
      { p: `Streaks make you want to do more. The answer is always less: fewer names, smaller size, shorter sessions. Tomorrow's size is set by last night's numbers, not by how this morning's market feels — and size returns the same way it left, one step at a time, as the equity curve earns it back. You cannot think your way back to even; you size your way back.` },
      { h: `Common mistakes` },
      { p: `Trading bigger to win it back — the one move that turns a drawdown into a hole. Skipping the review day because the setups "look too good to miss". Treating the size ladder as a suggestion. And declaring the system broken at four losses when the system's own history says four losses are ordinary.` },
    ],
  ...
  },
  {
    ...
    blocks: [
      { h: `Defining the terms` },
      { p: `The most common way to fail with a system like this is not breaking the rules — it is freezing while following them. The answer is simple: take the trade the system flagged, at a size you can survive being wrong at, and let the number of correct repetitions do the work that waiting for certainty never will.` },
      { h: `Why it matters` },
      ...
      { ul: [
        ...
        `Log the trades you [i]didn't[/i] take beside the ones you did. That list teaches you faster than your profit and loss does — most rejected setups were fine, and some rejected rules were right.`,
        `Judge the week on process, not on the result: did you take the setups the system flagged, cut what it said to cut, respect the three limits? Three yeses is a good week, whatever the number says.`,
      ] },
      { h: `In practice` },
      { p: `Being unsure is a reason to trade smaller, not a reason to skip the day. Do the deciding the night before, so the session is only execution. And grade the week on the three process questions before anyone looks at the profit and loss.` },
      { h: `Common mistakes` },
      { p: `Waiting for the perfect market, the perfect base and the perfect entry price while the leaders run without you, and the month ends flat with a notebook full of near-misses. Treating a green week as proof of good process and a red one as proof of bad. And only looking at your list of missed trades when it makes you feel better.` },
    ],
