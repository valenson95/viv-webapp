...
const SECTORS = {
  ...
  ...G("AI","NBIS","SMCI","VRT","BBAI","SOUN","AI","AMBA","TQQQ","SQQQ","QQQ","HPE","STX"/* DeepVue AI list, coverage audit 2026-08-06 */),
  ...G("Software","MSFT","ORCL","NOW","NTNX","CRM","SNOW","DDOG","MDB","TEAM","TWLO","DOCN","SHOP","PLTR","HUBS","WDAY","ADBE","INTU","APP","DOCU","PATH","GTLB","ESTC","CFLT","BILL","ASAN","MNDY","PCOR","BRZE","FROG","U","RBLX","PSTG","FIVN","INOD","FIG","BASE","CVLT","NCNO","DBX","BOX","NAVN"/* Nov-2025 IPO; industry-header lens (Packaged Software) — NOT yet in any captured DeepVue theme list, verify on next constituents drop */,"SMAR","PD","APPN","AYX","WK","YEXT","BL","GWRE","MANH","TYL","SPT","ZI","RNG","AVPT"/* DeepVue Software list, coverage audit 2026-08-06 */),
  ...G("Cybersecurity","CRWD","PANW","ZS","S","OKTA","NET","FTNT","TENB","RBRK","CYBR","VRNS","RPD","QLYS","AKAM","GEN","CHKP","FSLY"/* DeepVue Cybersecurity list (3M view), coverage audit 2026-08-06 */),
  ...
  ...G("Genomics","CRSP","NTLA","BEAM","EDIT","GH","TXG","PACB","NVTA","EXAS","VCYT","DNA","TWST","FLGT","NTRA","PSNL"/* triple-listed same %; most-specific wins + ARKG holds it 5.48% — audit 2026-08-06 */),
  ...
  ...G("HealthCare","UNH","HIMS","OSCR","CI","ELV","HCA","MOH","HUM","ALHC","AGL","DOCS","MCK","COR","CNC","THC","UHS","TDOC","PGNY","NEO"/* DeepVue HealthCare list — NOT Genomics (absent from its complete list), audit 2026-08-06 */),
  ...
  ...G("Oil & Gas","XOM","CVX","OXY","DVN","FANG","EQT","VLO","MPC","PSX","DINO","SLB","HAL","TRGP","LNG","CTRA","AR","RRC","OVV","MTDR","CHRD","EOG","COP","APA","HES","OII"/* DeepVue Oil & Gas list, coverage audit 2026-08-06 */),
  ...
  ...G("Financials","HOOD","SOFI","AFRM","UPST","NU","CRCL","PYPL","XYZ","FUTU","IBKR","LMND","TOST","BULL","STNE","PAGS","FOUR","GPN","WEX","JPM","GS","MS","BAC","C","SCHW","KKR","APO","BX","ARES","OWL"),
  ...
  ...G("Growth Stocks","NTAP","DAVE","SEZL","HNGE","TGTX"/* DeepVue Growth Stocks list, coverage audit 2026-08-06 */,"TSLA","RIVN","LCID","CAVA","DKNG","SN","CELH","ELF","DUOL","ONON","BROS","WING","ANF","RH","CROX","DECK","SG","CART","LULU","CMG","TTD","AS","BIRK","MELI"),
  ...
  ...G("Retail","WMT","CHEF","COST","TGT","DKS","BURL","ULTA","DPZ","TJX","ROST","FIVE","BOOT","WSM","ORLY","AZO","URBN","KMX","PTRN"/* Pattern Group (NOT Patterson); XRT holds it; specific-wins over Growth Stocks — audit 2026-08-06 */,"VSXY","AMZN"/* Victoria's Secret — DeepVue chart annotation "Specialty Retail", Valen 2026-08-04 */),
  ...
  ...G("Technology","DELL","HPQ","ANET","WDC","JBL","FLEX","CLS","APH","GLW","TEL"),
};
