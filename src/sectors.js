...
const SECTORS = {
  ...
  ...G("Biotechnology","MRNA","BNTX","VRTX","REGN","GILD","BIIB","AMGN","PTCT","SRPT","RARE","BMRN","IONS","ARWR","ALNY","INCY","EXEL","HALO","CYTK","KRYS","MDGL","VKTX","KYMR","SEPN","SYRE","TNGX","ADPT","TVTX","KOD","HROW","CPRX","RYTM","INSM","AXSM","IMVT","ARDX","BBIO","ACAD","NBIX","JAZZ","APLS","IOVA","RXRX","VERV","DVAX","CORT","SMMT","PCVX","RVMD"),
  ...G("Genomics","CRSP","NTLA","BEAM","EDIT","GH","TXG","PACB","NVTA","EXAS","VCYT","DNA","TWST","FLGT","NTRA"),
  ...G("Medical","ISRG","BLFS","BRKR","HAE","DXCM","PODD","TMDX","GKOS","PEN","INSP","TNDM","IRTC","NARI","SILK","BSX","MDT","SYK","EW","ALGN","RMD","GEHC","IDXX","DGX","SOLV","LNTH","AXNX","PRCT"),
  ...
  ...G("Retail","WMT","CHEF","COST","TGT","DKS","BURL","ULTA","DPZ","TJX","ROST","FIVE","BOOT","WSM","ORLY","AZO","URBN"),
